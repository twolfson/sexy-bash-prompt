...
esc=$'\033'
  ...
  TERM=xterm-256color PROMPT_USER_COLOR='\033[1;32m' PROMPT_PREPOSITION_COLOR='\033[1;33m' PROMPT_DEVICE_COLOR='\033[1;34m' PROMPT_DIR_COLOR='\033[1;35m' PROMPT_GIT_STATUS_COLOR='\033[1;36m' PROMPT_SYMBOL_COLOR='\033[1;37m' . .bash_prompt
    ...
    # use the new colors
    expected_prompt='\[\033[1;32m\]\u\['$esc'(B'$esc'[m\] \[\033[1;33m\]at\['$esc'(B'$esc'[m\] \[\033[1;34m\]\h\['$esc'(B'$esc'[m\] \[\033[1;33m\]in\['$esc'(B'$esc'[m\] \[\033[1;35m\]\w\['$esc'(B'$esc'[m\]$( is_on_git &&   echo -n " \[\033[1;36m\]on\['$esc'(B'$esc'[m\] " &&   echo -n "\[\033[1;37m\]$(get_git_info)" &&   echo -n "\[\033[1;33m\]")\n\['$esc'(B'$esc'[m\]\[\]$ \['$esc'(B'$esc'[m\]'
    echo $PS1
    echo $expected_prompt
